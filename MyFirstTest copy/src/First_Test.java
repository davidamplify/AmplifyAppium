...
public class First_Test {
    ...
    public void setup() throws MalformedURLException {
        ...
        capabilities.setCapability("app", "/Users/devops/Library/Developer/Xcode/DerivedData/Amplify-adjlxbivtxbvxcbyssijlzqwdwtg/Build/Products/Debug-iphonesimulator/Amplify.app");
...
//        password.setValue("Bucketandspade6");
        ...
        IOSElement backButton = (IOSElement) driver.findElementByAccessibilityId("arrow back");
        backButton.click();
        setDriverToWebContext();
